...
$topline += $toppadding;
imagettftext($img, 10, 0, $x, $topline+5, $lc, "arial.ttf", $maxstr);
imageline($img, $numwidth+1, $topline, $width, $topline, $gc);
/* half */
$half = $max / 2;
...
imagettftext($img, 10, 0, $x, $y+5, $lc, "arial.ttf", $halfstr);
imageline($img, $numwidth+1, $y, $width, $y, $gc);
/* zero */
$x = $numwidth - LabelWidth("0");
$y = $graph_height / 2 + $topline;
imagettftext($img, 10, 0, $x, $y+5, $lc, "arial.ttf", "0");
imageline($img, $numwidth+1, $y, $width, $y, $gc);

/* min */
$y = $topline + $graph_height;
$x = $numwidth - LabelWidth($minstr);
imagettftext($img, 10, 0, $x, $y+5, $lc, "arial.ttf", $minstr);
imageline($img, $numwidth+1, $y, $width, $y, $gc);
...
//	print "$l<br>\n";
	...
	$lw = LabelWidth($lrev);
	$lx = $x - $lw / 2;
	imagettftext($img, 10, 0, $lx, $ystart, $lc, "arial.ttf", $lrev);
	/* vertical line */
