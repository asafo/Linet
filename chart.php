...
//		print "$labe_output<br>\n";
		$sizearr = imagettfbbox(10, 0, "fonts/arial.ttf", $label_output);
		$txtsize = $sizearr[2] - $sizearr[0];
		$x = ($width + $xtra_width - 20 - $txtsize);
//		imagettftext($img, 10, 0, $width + 20, $label_place + 10, colorHex($img, $text_color), "fonts/arial.ttf", $label_output);
		imagettftext($img, 10, 0, $x, $label_place + 10, colorHex($img, $text_color), "fonts/arial.ttf", $label_output);
