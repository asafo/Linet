...
if(!$companies) {
	...
	$query .= "num1 INTEGER, ";		/* beginning number for ׳”׳¦׳¢׳× ׳�׳—׳™׳¨ */
	$query .= "num2 INTEGER, ";		/* beginning number for ׳”׳–׳�׳ ׳” */
	$query .= "num3 INTEGER, ";		/* beginning number for ׳—׳©׳‘׳•׳� ׳¢׳¡׳§׳” */		
	$query .= "num4 INTEGER, ";		/* beginning number for ׳×׳¢׳•׳“׳× ׳�׳©׳�׳•׳— */
	$query .= "num5 INTEGER, ";		/* beginning number for ׳—׳©׳‘׳•׳ ׳™׳× */
	$query .= "num6 INTEGER, ";		/* beginning number for ׳—׳©׳‘׳•׳ ׳™׳× ׳–׳™׳›׳•׳™ */	
	$query .= "num7 INTEGER, ";		/* beginning number for ׳×׳¢׳•׳“׳× ׳”׳—׳–׳¨׳” (not used) */
	$query .= "num8 INTEGER ";		/* beginning number for ׳§׳‘׳�׳” */
	$query .= ")";
	$result = mysql_query($query);
	if(!$result) {
		echo mysql_error();
