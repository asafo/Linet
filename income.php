...
function PrintCustomerSelect($def) {
	...
	print "<option value=\"__NULL__\">-- ׳‘׳—׳¨ ׳�׳§׳•׳— --</option>\n";
	while($line = mysql_fetch_array($result, MYSQL_NUM)) {
		$n = $line[0];
		$company = $line[1];
		if($n == $def)
...
if($step == 0) {
	$t = CUSTOMER;
	print "&nbsp;&nbsp;<a href=\"index.php?module=acctadmin&action=addacct&type=$t\">׳”׳’׳“׳¨ ׳�׳§׳•׳— ׳—׳“׳©</a>\n";
}
print "</td></tr>\n";
print "<tr>\n";
...
if($step == 0) {
	$t = INCOME;
	print "<br><a href=\"index.php?module=acctadmin&action=addacct&type=$t\">׳”׳’׳“׳¨ ׳¡׳¢׳™׳£ ׳”׳›׳ ׳¡׳” ׳—׳“׳©</a>\n";
}
print "</td></tr>\n";
print "<tr>\n";
...
print "<td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\"׳¢׳“׳›׳�\">\n";
print "</td></tr>\n";
print "</table>\n";
print "</form>\n";
